  ...
  <div class="vip-info-wrapper">
    ...
    <el-popover
      ...
      <el-table :data="gridData">
        <el-table-column width="100" property="grade" label="等级"></el-table-column>
        <el-table-column width="150" property="money" label="消费金额"></el-table-column>
        <el-table-column width="200" property="discount" label="折扣享受"></el-table-column>
      </el-table>
    </el-popover>
    <el-popover
      ref="popover2"
