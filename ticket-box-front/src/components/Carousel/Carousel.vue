    ...
    <div class="carousel-area-wrapper">
        <el-row :gutter="20" style="margin: 0">
            <el-col :xs="10" :sm="10" :md="10" :lg="10" style="min-height: 100px;">
                <transition name="el-fade-in-linear">
                    <div class="welcome-wrapper" v-show="showInfo">
                        ...
                        <h1>哈哈哈哈哈哈哈哈哈哈哈哈哈</h1>
                        <h1><span style="color: #FEC581;">郭顶</span>与您相约</h1>
            ...
            <el-col :xs="14" :sm="14" :md="14" :lg="14">
                ...
                <el-carousel type="card" height="500px" style="width: 700px; margin-left: 50px;" @change="changePic" arrow="never"
                             ref="carousel">
                    <el-carousel-item v-for="item in 5" :key="item" style="border-radius: 10px;">
                        <!--<h3>{{ item }}</h3>-->
